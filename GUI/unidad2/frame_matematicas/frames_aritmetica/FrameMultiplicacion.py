...
class FrameMultiplicacion(FrameAritmetica):
    """
    Clase que representa un marco para realizar la operación de multiplicación.

    Esta clase es una subclase de FrameAritmetica y proporciona una interfaz para realizar la operación de multiplicación
    ...
    def __init__(self, master):
        """
        Inicializa un nuevo FrameMultiplicacion.
        ...
        self._etiqueta_titulo.configure(text="Multiplicar")

    def _calcular_resultado(self):
        """
        Calcula el resultado de la multiplicación e inserta el resultado en el campo correspondiente.
